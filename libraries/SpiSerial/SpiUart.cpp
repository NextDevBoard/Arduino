#include "SpiUart.h" // See section 8.10 of the datasheet for definitions // of bits in the Enhanced Features Register (EFR)
...
struct SPI_UART_cfg SPI_Uart_config = {
  ...
  // lose data. Note that flow control 
  // is not supported on the Nextion.
...
unsigned char SpiUartDevice::ioGetState() {
  /*
   */
